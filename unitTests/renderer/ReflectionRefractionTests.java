...
public class ReflectionRefractionTests {
    ...
    public void xx() {
        ...
        scene.geometries.add(// Triangle with transparency, reflection, and specular
                ...
                new Sphere(new Point(-50, 50, -50), 15d).setEmission(new Color(0, 255, 255))
                        .setMaterial(new Material().setKd(0.4).setKs(0.2).setShininess(80).setKt(0.8)),
                // Reflective sphere
                new Sphere(new Point(50, 50, -50), 15d).setEmission(new Color(255, 255, 0))
    ...
    public void manyShapes() {
        ...
        scene.geometries.add(
                new Sphere(new Point(-100, 100, -100), 20d)
                        .setEmission(new Color(BLUE))
                        .setMaterial(new Material().setKd(0.4).setKs(0.3).setShininess(100).setKt(0.3)),
                new Sphere(new Point(-100, 100, -100), 10d)
                        .setEmission(new Color(RED))
                        .setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(100)),
                new Sphere(new Point(-50, 50, -50), 15d)
                        .setEmission(new Color(RED))
                        .setMaterial(new Material().setKd(0.6).setKs(0.4).setShininess(80)),
                new Sphere(new Point(50, -50, -50), 10d)
                        .setEmission(new Color(YELLOW))
                        .setMaterial(new Material().setKd(0.7).setKs(0.6).setShininess(120)),
                new Sphere(new Point(-50, -50, -50), 20d)
                ...
                new Sphere(new Point(-19.5, -9, -10), 10d)
                        .setEmission(new Color(0, 50, 150))
                        .setMaterial(new Material().setKd(0.25).setKs(0.25).setShininess(20)
                                .setKt(new Double3(0.5, 0, 0))),
                new Sphere(new Point(-19.5, -9, -10), 9d)
